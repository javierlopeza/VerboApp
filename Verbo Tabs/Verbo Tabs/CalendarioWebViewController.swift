//
//  CalendarioWebViewController.swift
//  Verbo Tabs
//
...
class CalendarioWebViewController: UIViewController {

    @IBOutlet weak var CalendarioWebView: UIWebView!
    ...
    override func viewDidLoad() {
        ...
        CalendarioWebView.loadRequest(request)
    }
